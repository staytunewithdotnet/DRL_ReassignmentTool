...
{
   public class CustomerRepository : GenericRepository<EF.CustomerMaster>, ICustomerRepository
    {
        private readonly ILogger logger;

        public CustomerRepository(IUnitOfWork unitOfWork, ILogManager logManager) : base(unitOfWork, logManager)
        {
            _uow = unitOfWork;
